...
//			->setBody($emailFields['message']);
    ...
    $phpExcelObject->getActiveSheet()->setTitle('Tab Title');
        ...
        //$email->attach(\Swift_Attachment::fromPath($files_root_path . "/../tmp/temp.xlsx"));
        $email->attach(\Swift_Attachment::fromPath($ftemp)->setFilename('shipment_details.xlsx'));
